...
# -----------------------------------------------------------------------------
# BacktestFastV2: Drop-in replacement for BacktestFast with same interface
# -----------------------------------------------------------------------------
import pandas as pd
...
class BacktestFastV2:
    ...
    Same interface as BacktestFast - just change the import:
        from backtest_engine_minimal_fast import BacktestFastV2 as BacktestFast
    """
    ...
    def __init__(
        ...
        self._master_pl = None
        self._datefile_pl = None
        self._signal_pl = None
        self._engine = None
...
if __name__ == "__main__":
    # BacktestFastV2 has same interface as BacktestFast:
    #
    # bt = BacktestFastV2(
    #     infile=signal_df,
    #     retfile=ret_df,
